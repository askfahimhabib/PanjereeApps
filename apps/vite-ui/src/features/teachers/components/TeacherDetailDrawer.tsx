        ...
        {!teacher ? null : (
          <>
            ...
            <div className="flex items-center justify-between px-5 py-3 border-b border-zinc-100 shrink-0">
              <span className="text-xs font-semibold uppercase tracking-widest text-zinc-600">Teacher Profile</span>
              <button
                onClick={onClose}
            ...
            <div className="flex items-center gap-4 px-5 py-4 border-b border-zinc-100 bg-zinc-50 shrink-0">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-base font-bold text-zinc-900 truncate">{teacher.fullName}</h2>
                {teacher.nameBangla && (
                  <p className="text-xs text-zinc-600 truncate">{teacher.nameBangla}</p>
                )}
              ...
              <div className="shrink-0 text-right">
                <p className="text-[10px] text-zinc-600">Teacher ID</p>
                <p className="text-xs font-mono font-semibold text-zinc-800">{teacher.teacherId}</p>
              </div>
            </div>
