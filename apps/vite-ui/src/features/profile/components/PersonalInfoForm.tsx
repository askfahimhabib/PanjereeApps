...
export function PersonalInfoForm() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Role — read only */}
      <div className="space-y-1.5">
        <label className="text-xs font-semibold text-zinc-600 uppercase tracking-wider">Role</label>
        <div className="flex items-center gap-3 bg-white shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border-zinc-200 border border-zinc-100 rounded-2xl px-4 py-2.5">
          <span className="text-sm text-zinc-600">{profile.role}</span>
          <span className="ml-auto text-[10px] text-zinc-800 italic">Read-only</span>
        </div>
      </div>
