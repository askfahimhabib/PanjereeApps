      ...
      <div
        ...
        className={`flex-1 border-2 border-dashed rounded-xl p-4 text-center transition-all cursor-pointer ${
          dragging
            ...
            : 'border-zinc-100 hover:border-zinc-100 hover:bg-zinc-50'
        }`}
      >
        <Upload size={18} className="mx-auto mb-2 text-zinc-600" />
        <p className="text-sm text-zinc-600">Drag & drop or <label className="text-indigo-400 cursor-pointer hover:underline">
          browse
        ...
        <p className="text-[11px] text-zinc-800 mt-1">PNG, JPG up to 5MB</p>
      </div>
