    ...
    <div className="space-y-6">
              ...
              <button
                ...
                className={`flex flex-col items-center gap-2 p-3 rounded-xl border transition-all ${
                  isActive
                    ...
                    : 'border-zinc-100 hover:border-zinc-100 bg-zinc-50'
                }`}
              >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-1.5">
          <label className="text-xs font-semibold text-zinc-600 uppercase tracking-wider">Primary Color</label>
          <div className="flex items-center gap-3 bg-white shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border-zinc-200 border border-zinc-100 rounded-2xl px-4 py-2.5">
            <input
              type="color"
              value={primary}
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-semibold text-zinc-600 uppercase tracking-wider">Accent Color</label>
          <div className="flex items-center gap-3 bg-white shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border-zinc-200 border border-zinc-100 rounded-2xl px-4 py-2.5">
            <input
              type="color"
              value={accent}
      ...
      {/* Preview */}
      <div className="p-4 rounded-xl border border-zinc-100 space-y-3" style={{ borderColor: `${primary}30` }}>
        <p className="text-xs text-zinc-600 uppercase tracking-wider">Preview</p>
