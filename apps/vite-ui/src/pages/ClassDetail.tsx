      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border-zinc-200 border border-zinc-100 rounded-2xl p-5">
        <div>
          <div className="flex items-center gap-3 mb-1">
            <h1 className="text-2xl font-bold text-zinc-900 tracking-tight">{classData.name}</h1>
          ...
          <p className="text-sm text-zinc-600">
            ...
            <span className="text-zinc-800">{classData.totalStudents}</span> Students &nbsp;·&nbsp;
            <span className="text-zinc-800">{classData.totalSections}</span> Sections
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button className="flex items-center gap-2 bg-zinc-50 hover:bg-zinc-50 text-zinc-800 border border-zinc-100 px-3 py-2 rounded-xl text-sm font-medium transition-colors">
            <Download size={15} />
            Export List
          </button>
          <button
            onClick={() => setIsSetFeeOpen(true)}
            className="flex items-center gap-2 bg-zinc-50 hover:bg-zinc-50 text-zinc-800 border border-zinc-100 px-3 py-2 rounded-xl text-sm font-medium transition-colors"
          >
