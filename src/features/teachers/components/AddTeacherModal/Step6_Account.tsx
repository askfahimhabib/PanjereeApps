        ...
        <div className="space-y-3 pt-1">
          <div>
            <label className={labelCls}>
              ...
              {isEdit && <span className="text-slate-500 font-normal"> (leave blank to keep current)</span>}
            </label>
      ...
      <div className={sectionCls}>
        ...
        <div className="mt-2 p-3 bg-slate-800/50 border border-slate-700/50 rounded-lg">
          ...
          {data.role === 'ASSISTANT_TEACHER' && (
            <p className="text-xs text-slate-300">📝 <strong>Assistant Teacher:</strong> Can take attendance, enter results, and view their assigned classes.</p>
          )}
        </div>
      </div>
    </div>
