...
import { MOCK_CLASSES, MOCK_SECTIONS, MOCK_SUBJECTS } from '../../mockData'
      ...
      <div className={sectionCls}>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">Assign which classes and subjects this teacher will teach this year.</p>
          </div>
          <button
        ...
        <div className="space-y-4">
          {data.assignments.map((a, idx) => (
            <div key={idx} className="bg-slate-800/60 border border-slate-700 rounded-xl p-4 space-y-3">
              {/* Header row */}
              <div className="flex items-center justify-between">
                <span className="text-xs text-slate-400 font-semibold">Assignment #{idx + 1}</span>
