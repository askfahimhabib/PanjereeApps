      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
            data.teacherCategory === 'REGULAR' ? 'bg-emerald-600' : 'bg-slate-700'
          }`}>
            <UserCog size={20} className="text-white" />
          </div>
          <div className="text-center">
            <p className={`font-semibold text-sm ${data.teacherCategory === 'REGULAR' ? 'text-emerald-300' : 'text-slate-300'}`}>
              Regular Teacher
            </p>
        ...
        >
          ...
          <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
            data.teacherCategory === 'GUEST' ? 'bg-violet-600' : 'bg-slate-700'
          }`}>
            <Star size={20} className="text-white" />
          </div>
          <div className="text-center">
            <p className={`font-semibold text-sm ${data.teacherCategory === 'GUEST' ? 'text-violet-300' : 'text-slate-300'}`}>
              Guest Teacher
            </p>
            <p className="text-[11px] text-slate-500 mt-0.5 leading-snug">
