      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="sm:col-span-2">
            <p className="text-xs text-slate-500">Teacher Category</p>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-slate-200 font-medium">{DESIGNATION_LABELS[teacher.designation]}</p>
            </div>
          </div>

          {teacher.department && (
            <div className="flex items-start gap-2">
              <Building2 size={14} className="text-slate-500 mt-0.5" />
              <div>
                <p className="text-xs text-slate-500">Department</p>
                <p className="text-sm text-slate-200 font-medium">{DEPARTMENT_LABELS[teacher.department]}</p>
              </div>
            </div>
          )}
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-slate-200 font-medium">{teacher.joiningDate}</p>
              <p className="text-xs text-slate-500 mt-0.5">Service: {yearsOfService(teacher.joiningDate)}</p>
            </div>
          </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {teacher.terminationReason && (
              <div className="sm:col-span-2">
                <p className="text-xs text-slate-500">Termination Reason</p>
