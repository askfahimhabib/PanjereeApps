      ...
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-xl shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between p-5 border-b border-slate-800 flex-shrink-0">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Define fees for a class or batch</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          {/* Name */}
          <div>
            <label className="block text-xs font-medium text-slate-400 mb-1.5">Structure Name *</label>
            <input
              type="text"
          ...
          {/* Target Type */}
          <div>
            <label className="block text-xs font-medium text-slate-400 mb-2">Target *</label>
          ...
          {targetType === 'CLASS' ? (
            <div>
              <label className="block text-xs font-medium text-slate-400 mb-1.5">Select Class *</label>
              <select
                value={classId}
                onChange={e => {
            ...
            <div>
              <label className="block text-xs font-medium text-slate-400 mb-1.5">Select Batch *</label>
              <select
                value={batchId}
          ...
          <div>
            ...
            <div className="space-y-3">
              {items.map((item, idx) => (
                <div key={item.tempId} className="bg-slate-800/60 border border-slate-700/60 rounded-xl p-3 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {/* Label */}
                    <div>
                      <label className="block text-[10px] text-slate-500 mb-1">Display Label</label>
                      <input
                        type="text"
                        value={item.label}
                  ...
                  {item.frequency === 'MONTHLY' && (
                    <div>
                      <label className="block text-[10px] text-slate-500 mb-1">Due Day (day of month)</label>
                      <input
                        type="number"
                        min={1}
                        max={31}
                        ...
                        placeholder="e.g. 5"
                        className="w-32 bg-slate-900 border border-slate-700 rounded-md px-2 py-1.5 text-xs text-slate-200 focus:outline-none focus:border-emerald-500"
                      />
                    </div>
                  )}
                </div>
