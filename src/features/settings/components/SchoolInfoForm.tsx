  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        {/* School Name BN */}
        <div className="space-y-1.5">
          <label className="text-xs font-semibold text-slate-400 uppercase tracking-wider">School Name (বাংলা)</label>
          <input
        ...
        <div className="sm:col-span-2 space-y-1.5">
          <label className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Tagline / Motto</label>
          <input
            value={form.tagline}
        ...
        <div className="sm:col-span-2 space-y-1.5">
          ...
          <textarea
            ...
            rows={2}
            className="w-full bg-slate-800/60 border border-slate-700 rounded-xl px-4 py-2.5 text-sm text-slate-200 placeholder-slate-600 focus:outline-none focus:border-indigo-500/60 focus:ring-1 focus:ring-indigo-500/20 transition-all resize-none"
          />
        </div>
        {/* Phone */}
        <div className="space-y-1.5">
